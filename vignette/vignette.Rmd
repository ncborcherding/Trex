...
load("~/Documents/GitHub/Trex/data/Trex.Data.rda")
...
eigen <- maTrex(tmp, AA.method = "mean", nearest.method = "threshold", AA.properties = "AF")
eigen2 <- maTrex(tmp, AA.method = "auto", nearest.method = "threshold", 
                 AA.properties = "AF")
